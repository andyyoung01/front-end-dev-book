...
var ChatApp = function ChatApp() {
    ...
    _wsClient2.default.registerOpenHandler(function () {
        _this.chatForm.init(function (form_input_val) {
            var message = new ChatMessage({ message: form_input_val });
